...
assert_contains "$entry" 'for component in saha_matter gree_cloud midea_smart_home'
assert_contains "$entry" 'homeassistant/custom_components/$component'
assert_contains "$entry" 'ha-template/deps/lupa'
assert_contains "$entry" 'python-wheels'
...
assert_contains "$entry" 'ROBAN_S2S_IMAGE_TAG:-20260907-door-sensor-arm64'
