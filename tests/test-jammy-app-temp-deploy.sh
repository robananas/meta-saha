...
contains "$entry" 'ROBAN_REQUIRED_TCP_PORTS="5580 8080 8123 8765 8888 8889"'
...
contains "$dir/compose.yaml" 'ROBAN_S2S_HA_MCP_URL: http://127.0.0.1:8888/mcp'
contains "$dir/compose.yaml" 'ROBAN_S2S_WORKFLOW_MCP_URL: http://127.0.0.1:8889/mcp'
