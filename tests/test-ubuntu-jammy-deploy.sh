...
assert_contains "$noble" 'ROBAN_S2S_IMAGE_TAG:-20260902-catalog-primary-fix-arm64'
...
assert_contains "$root/scripts/saha-jammy-app-temp-deploy" 'ROBAN_S2S_IMAGE_TAG:-20260902-catalog-primary-fix-arm64'
