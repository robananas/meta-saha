...
assert_contains "$noble" 'ROBAN_S2S_IMAGE_TAG:-20260826-json-tool-plugins-cpu-arm64'
...
assert_contains "$root/scripts/saha-jammy-app-temp-deploy" 'ROBAN_S2S_IMAGE_TAG:-20260826-json-tool-plugins-cpu-arm64'
