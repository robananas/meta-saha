...
assert_contains "$noble" 'ROBAN_WORKFLOW_IMAGE_TAG:-20260902-ha-refresh-arm64'
...
assert_contains "$noble" 'ROBAN_S2S_IMAGE_TAG:-20260907-door-sensor-arm64'
assert_contains "$root/scripts/saha-jammy-app-temp-deploy" 'roban-workflow-mcp'
assert_contains "$root/scripts/saha-jammy-app-temp-deploy" 'ROBAN_WORKFLOW_IMAGE_TAG:-20260902-ha-refresh-arm64'
...
assert_contains "$root/scripts/saha-jammy-app-temp-deploy" 'custom_components/midea_smart_home'
assert_contains "$root/scripts/saha-jammy-app-temp-deploy" 'for component in saha_matter gree_cloud midea_smart_home'
assert_contains "$root/scripts/saha-jammy-app-temp-deploy" 'ha-template/deps/lupa'
assert_contains "$root/scripts/saha-jammy-app-temp-deploy" 'python-wheels'
