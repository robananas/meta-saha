...
assert_contains "$noble" 'ROBAN_S2S_IMAGE_TAG:-20260826-catalog-permission-cpu-arm64'
...
assert_contains "$root/scripts/saha-jammy-app-temp-deploy" 'ROBAN_S2S_IMAGE_TAG:-20260826-catalog-permission-cpu-arm64'
