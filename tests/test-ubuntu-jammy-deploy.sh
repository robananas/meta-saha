...
assert_contains "$noble" 'ROBAN_S2S_IMAGE_TAG:-20260825-card-capabilities-barge-cpu-arm64'
...
assert_contains "$root/scripts/saha-jammy-app-temp-deploy" 'ROBAN_S2S_IMAGE_TAG:-20260825-card-capabilities-barge-cpu-arm64'
