...
SRC_URI = " file://saha-data-layout.service file://saha-data-layout.sh file://var-log-journal.mount file://docker.conf file://daemon.json file://containerd.conf file://config.toml file://journald-data.conf file://saha-preload-sync file://saha-verify-data "
inherit systemd
S = "${UNPACKDIR}"
SYSTEMD_SERVICE:${PN} = "saha-data-layout.service var-log-journal.mount"
...
do_install() {
 ...
 for unit in saha-data-layout.service var-log-journal.mount; do install -m 0644 ${UNPACKDIR}/$unit ${D}${systemd_system_unitdir}/$unit; done
