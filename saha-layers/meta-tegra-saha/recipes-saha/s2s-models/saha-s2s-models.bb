SUMMARY = "Pinned base speech resources for Roban S2S"
DESCRIPTION = "Seeds only the offline KWS and VAD resources required before managed STT, LLM, and TTS models are installed."
LICENSE = "CLOSED"
...
do_install() {
    ...
    chown -R root:root ${D}/models/s2s
    ...
    chown root:root ${D}/models/s2s/manifest.sha256
